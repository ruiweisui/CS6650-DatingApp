...
public class Main {
    private static final String HOSTNAME = "35.93.154.103";
    ...
    public static ConcurrentHashMap<String, LikesObject> likesDict;
    ...
    public static void main(String[] argv) throws Exception {
        ...
        for (int i = 0; i < NUM_OF_THREAD; i++){
            Runnable thread = new ConsumerOne(connection, likesDict, completed);
