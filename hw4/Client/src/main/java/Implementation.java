...
public class Implementation implements Runnable{
    ...
    final String LOCAL_URL = "http://localhost:8080/PostServletNonRMQ_war_exploded/Twinder/";
    final String AWS_URL = "http://54.149.136.249:8080/PostServletNonRMQ_war/Twinder/";
    final String SPRING_URL = "http://localhost:8080";
    final String AWS_SPRING_URL = "http://34.221.144.118:8080";
    final String LOAD_BALANCE_URL = "http://ServerLoadBalancer-1671705404.us-west-2.elb.amazonaws.com:8080/server-hw2_war/Twinder/";
